...
const languages = {
    german: {
        ...
        "verify": {
            ...
            max: $.validator.format("Bitte geben sie einen Wert kleiner als oder gleich {0} ein."),
            min: $.validator.format("Bitte geben sie einen Wert größer als oder gleich {0} ein."),
        }
    },
    english: {
        "#table_th_label_rufnummer": {
...
function showError(errorMessage) {
    if (errorMessage)
        $('#errorpop_errmsg').html(errorMessage);
